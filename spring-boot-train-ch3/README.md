...
从 Spring3.1 开始，计划任务在 Spring 中的实现变的异常的简单。首先通过在配置类的注解 @EnableScheduling 来开启对计划任务的支持，然后在要执行计划任务的方法上注解 @Scheduled，声明这是一个计划任务
...
[](url "title")
<img src="https://raw.githubusercontent.com/topsale/spring-boot-train/master/screenshots/ch3-003.png">